...
INSERT INTO `lists` (`id`, `user_id`, `title`, `description`, `expiration`, `token`, `edit_token`, `is_public`) VALUES
...
(20, 4, 'Visite guidée', 'Visite guidée personnalisée de Saint-Epvre jusqu’à Stanislas', 'place.jpg', '', 11.00),
(21, 4, 'Exposition', 'Visite guidée de l’exposition ‘REGARDER’ à la galerie Poirel', 'poirelregarder.jpg', '', 14.00);
